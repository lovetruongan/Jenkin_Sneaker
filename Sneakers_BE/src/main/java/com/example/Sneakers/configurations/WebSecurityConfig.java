                ...
                .authorizeHttpRequests(requests -> {
                    requests
                            ...
                            .requestMatchers(DELETE,
                                    String.format("%s/carts/**", apiPrefix)).hasRole(Role.USER)
                                .requestMatchers(GET,
                                        String.format("%s/payments/status/**", apiPrefix)).permitAll()

                                        .requestMatchers(POST,
                                        String.format("%s/payments/callback/**", apiPrefix)).permitAll()

                                        .requestMatchers(POST,
                                        String.format("%s/payments/create", apiPrefix)).hasRole(Role.USER)

                                        .requestMatchers(GET,
                                        String.format("%s/payments/user", apiPrefix)).hasRole(Role.USER)

                                        .requestMatchers(POST,
                                        String.format("%s/payments/process", apiPrefix)).hasRole(Role.ADMIN)

                                        .requestMatchers(GET,
                                        String.format("%s/payments/admin/**", apiPrefix)).hasRole(Role.ADMIN)
